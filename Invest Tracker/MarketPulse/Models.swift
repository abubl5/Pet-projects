...
extension MarketAsset {
    static let samples: [MarketAsset] = [
        MarketAsset(
            ...
            summary: "Крупная технологическая компания с сильной экосистемой устройств и сервисов.",
        ...
        MarketAsset(
            ...
            thesis: ["рост Azure", "диверсифицированная выручка", "сильная позиция в enterprise"],
            risks: ["высокая оценка", "замедление корпоративных бюджетов", "давление конкурентов в cloud"]
        ),
        MarketAsset(
            id: "nvda",
            ticker: "NVDA",
            ...
            summary: "Ключевой бенефициар роста спроса на AI-чипы и дата-центры.",
            thesis: ["лидерство в GPU", "спрос со стороны AI", "высокие темпы роста выручки"],
            risks: ["волатильность", "цикличность полупроводников", "зависимость от больших клиентов"]
        ),
        MarketAsset(
            id: "spy",
            ticker: "SPY",
        ...
        MarketAsset(
            ...
            thesis: ["экспозиция на тех", "ростовая история", "понятный набор лидеров рынка"],
            risks: ["концентрация в технологиях", "чувствительность к ставкам", "повышенная волатильность"]
        ),
        MarketAsset(
            id: "btc",
            ticker: "BTC",
